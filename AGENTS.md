...
CI has no Postgres, so DB-touching tests (the `internal/handlers/derpies`,
`internal/handlers/gimmick`, and `internal/handlers/strava` integration
tests, `internal/dbmigrate`,
